 ...
 */
export type Debounce = (el: EventTarget, func: (e?: Event) => void, wait: number, immediate?: boolean) => LimittedHandler;
/**
 * A type representing a function that limits the execution rate of another function
 ...
 * @returns {LimittedHandler} - A handler with a cancel method to stop the invocation.
 */
export type Throttle = (el: EventTarget, func: (e?: Event) => void, wait: number, options?: {
    leading?: boolean;
    trailing?: boolean;
}) => LimittedHandler;
/**
