...
export type ValidationOption = {
    [key: string]: [ValidatorFunction, FunctionParameter] | [ValidatorFunction, FunctionParameter[]] | FunctionParameter | FunctionParameter[] | {
 ...
 */
export type ValidityStateKeys = Exclude<keyof ValidityState, "customError" | "valid">;
/**
 ...
 */
export type InputLimit = "none" | "debounce" | "throttle" | `debounce:${number}` | `throttle:${number}`;
/**
 ...
 */
export type ValidatorFunction = (el: HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement, value: string | string[] | File[]) => boolean;
/**
 ...
 */
export type FunctionParameter = object | string | number | boolean;
