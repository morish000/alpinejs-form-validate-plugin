...
import type { FieldValidationConfig, FormValidationConfig } from "./config_types.ts";
 ...
 */
export type CreateFormValidator = (form: HTMLFormElement, config: FormValidationConfig) => () => boolean;
/**
 ...
 */
export type CreateFieldValidator = (Alpine: Alpine) => (el: FormFieldElements, config: FieldValidationConfig, functions: Functions) => () => void;
