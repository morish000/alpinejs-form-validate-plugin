...
exports.createValidatePluginDefault = exports.createValidatePlugin = exports.createValidatePluginInternal = void 0;
const index_js_1 = require("./utils/index.js");
const index_js_2 = require("./config/index.js");
const index_js_3 = require("./functions/index.js");
const index_js_4 = require("./validators/index.js");
/**
 ...
 */
const createValidatePluginInternal = ({ createMessageStore, createFormValidator, createFieldValidator, formDefaultConfig, fieldDefaultConfig, }) => ({ defaultFunctionsOptions = {}, defaultFormOptions = {}, defaultFieldOptions = {}, } = {}) => (Alpine) => {
    const functions = (() => {
        const opts = {
            fieldValueResolver: defaultFunctionsOptions.fieldValueResolver ??
                (0, index_js_3.createFieldValueResolver)(),
            messageResolver: defaultFunctionsOptions.messageResolver ??
                (0, index_js_3.createMessageResolver)(),
            ...
            inputRateLimitter: defaultFunctionsOptions.inputRateLimitter ??
                (0, index_js_3.createInputRateLimitter)(index_js_1.debounce, index_js_1.throttle),
            html5ValidationMessageResolver: defaultFunctionsOptions.html5ValidationMessageResolver ??
                (0, index_js_3.createHtml5ValidationMessageResolver)(),
        };
        return {
            ...opts,
    ...
    Alpine.directive("validate-form", (el, { expression }, { evaluate, cleanup }) => {
        ...
        const config = (() => {
            ...
            const merged = (0, index_js_1.merge)(formConfig, formOptions, formExpression);
    ...
    Alpine.directive("validate", (el, { expression }, { evaluate, cleanup }) => {
         ...
         */
        const config = (() => {
            const inputConfig = (0, index_js_1.merge)(fieldDefaultConfig(), defaultFieldOptions, el.form?._x_validation?.report != null
                ? {
                    report: el.form?._x_validation.report,
                }
                : {}, expression ? evaluate(expression) : {});
            inputConfig.v = (0, index_js_2.formatValidationConfig)(inputConfig.v);
            inputConfig.m = (0, index_js_2.formatMessageConfig)(inputConfig.m);
            return inputConfig;
        })();
        // console.log(config);
...
exports.createValidatePluginInternal = createValidatePluginInternal;
/**
 ...
 */
exports.createValidatePlugin = (0, exports.createValidatePluginInternal)({
    createMessageStore: index_js_3.createMessageStore,
    createFormValidator: index_js_4.createFormValidator,
    createFieldValidator: index_js_4.createFieldValidator,
    formDefaultConfig: index_js_2.formDefaultConfig,
    fieldDefaultConfig: index_js_2.fieldDefaultConfig,
});
/**
 ...
 */
exports.createValidatePluginDefault = (0, exports.createValidatePlugin)();
