...
exports.createInputRateLimitter = void 0;
/**
 ...
 */
const createInputRateLimitter = (debounce, throttle) => (el, handler, { inputLimit, inputLimitOpts }) => {
    if (!inputLimit) {
        return handler;
    }
    ...
    switch (method) {
        case "debounce":
             ...
             */
            return debounce(el, handler, Number(wait ?? inputLimitOpts.debounce.wait), inputLimitOpts.debounce.immediate);
        case "throttle":
            /**
             ...
             */
            return throttle(el, handler, Number(wait ?? inputLimitOpts.throttle.wait), inputLimitOpts.throttle.options);
        case "none":
...
exports.createInputRateLimitter = createInputRateLimitter;
