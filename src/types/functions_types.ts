 ...
 */
export type InputRateLimitterCreator = (
  el: EventTarget,
 ...
 */
export type Html5ValidationMessageResolver = (
...
export type CreateMessageStore = (
  ...
  functions: { messageResolver: MessageResolver },
  store?: Record<string, MessageStoreItem>,
) => MessageStore;
...
export type FormFieldElements =
  | (HTMLInputElement & ValidationFormFieldElement)
  | (HTMLSelectElement & ValidationFormFieldElement)
  | (HTMLTextAreaElement & ValidationFormFieldElement);
